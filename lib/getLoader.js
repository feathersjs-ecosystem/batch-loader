const { stableStringify, defaultCacheParamsFn, defaultCacheKeyFn } = require('./utils')

module.exports = class GetLoader {
  constructor({ service, cacheParamsFn = defaultCacheParamsFn, cacheKeyFn = defaultCacheKeyFn }) {
